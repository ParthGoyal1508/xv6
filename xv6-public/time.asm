  ...
  13:	c7 45 e0 00 00 00 00 	movl   $0x0,-0x20(%ebp)
{
  ...
  1d:	c7 45 e4 00 00 00 00 	movl   $0x0,-0x1c(%ebp)
    pid = fork();
  24:	e8 c1 02 00 00       	call   2ea <fork>
    if (pid != 0)
  29:	85 c0                	test   %eax,%eax
  2b:	74 4d                	je     7a <main+0x7a>
    {
        status = waitx(&a, &b);
  ...
  36:	50                   	push   %eax
  37:	e8 56 03 00 00       	call   392 <waitx>
  ...
  44:	ff 75 e0             	pushl  -0x20(%ebp)
  47:	68 a8 07 00 00       	push   $0x7a8
  4c:	6a 01                	push   $0x1
  4e:	e8 ed 03 00 00       	call   440 <printf>
    printf(1, "RunTime = %d\n", b);
  53:	83 c4 0c             	add    $0xc,%esp
  56:	ff 75 e4             	pushl  -0x1c(%ebp)
  59:	68 b7 07 00 00       	push   $0x7b7
  5e:	6a 01                	push   $0x1
  60:	e8 db 03 00 00       	call   440 <printf>
    printf(1, "Status = %d\n", status);
  65:	83 c4 0c             	add    $0xc,%esp
  68:	53                   	push   %ebx
  69:	68 c5 07 00 00       	push   $0x7c5
  6e:	6a 01                	push   $0x1
  70:	e8 cb 03 00 00       	call   440 <printf>
    exit();
  75:	e8 78 02 00 00       	call   2f2 <exit>
  ...
  82:	e8 a3 02 00 00       	call   32a <exec>
        printf(1, "exec %s failed\n", argv[1]);
  87:	83 c4 0c             	add    $0xc,%esp
  8a:	ff 76 04             	pushl  0x4(%esi)
  8d:	68 98 07 00 00       	push   $0x798
  92:	6a 01                	push   $0x1
  94:	e8 a7 03 00 00       	call   440 <printf>
  99:	83 c4 10             	add    $0x10,%esp
  9c:	eb a3                	jmp    41 <main+0x41>
  9e:	66 90                	xchg   %ax,%ax
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb d2 07 00 00       	mov    $0x7d2,%ebx
        while(*s != 0){
