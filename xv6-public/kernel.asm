...
80100a92:	75 d2                	jne    80100a66 <exec+0x56>
  if((pgdir = setupkvm()) == 0)
80100a94:	e8 a7 63 00 00       	call   80106e40 <setupkvm>
...
80100af6:	e8 65 61 00 00       	call   80106c60 <allocuvm>
...
80100b28:	e8 73 60 00 00       	call   80106ba0 <loaduvm>
...
80100b72:	e8 49 62 00 00       	call   80106dc0 <freevm>
...
80100baa:	e8 b1 60 00 00       	call   80106c60 <allocuvm>
...
80100bc1:	e8 fa 61 00 00       	call   80106dc0 <freevm>
...
80100bdb:	68 61 71 10 80       	push   $0x80107161
...
80100c06:	e8 d5 62 00 00       	call   80106ee0 <clearpteu>
  for(argc = 0; argv[argc]; argc++) {
...
80100c5d:	e8 de 63 00 00       	call   80107040 <copyout>
...
80100cc1:	89 8d 60 ff ff ff    	mov    %ecx,-0xa0(%ebp)
  if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100cc7:	e8 74 63 00 00       	call   80107040 <copyout>
...
80100d34:	e8 d7 5c 00 00       	call   80106a10 <switchuvm>
  freevm(oldpgdir);
80100d39:	89 3c 24             	mov    %edi,(%esp)
80100d3c:	e8 7f 60 00 00       	call   80106dc0 <freevm>
  return 0;
...
80100d66:	68 6d 71 10 80       	push   $0x8010716d
...
80100e2b:	68 74 71 10 80       	push   $0x80107174
...
80100f02:	68 7c 71 10 80       	push   $0x8010717c
...
80100fe2:	68 86 71 10 80       	push   $0x80107186
...
801010f5:	68 8f 71 10 80       	push   $0x8010718f
801010fa:	e8 91 f2 ff ff       	call   80100390 <panic>
  panic("filewrite");
801010ff:	83 ec 0c             	sub    $0xc,%esp
80101102:	68 95 71 10 80       	push   $0x80107195
...
80101173:	68 9f 71 10 80       	push   $0x8010719f
...
80101224:	68 b2 71 10 80       	push   $0x801071b2
...
80101352:	68 c8 71 10 80       	push   $0x801071c8
...
80101427:	68 d8 71 10 80       	push   $0x801071d8
...
8010148c:	68 eb 71 10 80       	push   $0x801071eb
...
801014a3:	68 f2 71 10 80       	push   $0x801071f2
801014a8:	53                   	push   %ebx
801014a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
801014af:	e8 dc 2d 00 00       	call   80104290 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801014f9:	68 58 72 10 80       	push   $0x80107258
...
801015c3:	68 f8 71 10 80       	push   $0x801071f8
...
801016a2:	e8 29 2c 00 00       	call   801042d0 <acquiresleep>
  if(ip->valid == 0){
...
8010173d:	68 10 72 10 80       	push   $0x80107210
80101742:	e8 49 ec ff ff       	call   80100390 <panic>
    panic("ilock");
80101747:	83 ec 0c             	sub    $0xc,%esp
8010174a:	68 0a 72 10 80       	push   $0x8010720a
...
80101773:	e8 f8 2b 00 00       	call   80104370 <holdingsleep>
...
8010178e:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
8010178f:	e9 9c 2b 00 00       	jmp    80104330 <releasesleep>
    panic("iunlock");
80101794:	83 ec 0c             	sub    $0xc,%esp
80101797:	68 1f 72 10 80       	push   $0x8010721f
...
801017c0:	e8 0b 2b 00 00       	call   801042d0 <acquiresleep>
...
801017da:	e8 51 2b 00 00       	call   80104330 <releasesleep>
  acquire(&icache.lock);
...
80101c42:	68 39 72 10 80       	push   $0x80107239
80101c47:	e8 44 e7 ff ff       	call   80100390 <panic>
    panic("dirlookup not DIR");
80101c4c:	83 ec 0c             	sub    $0xc,%esp
80101c4f:	68 27 72 10 80       	push   $0x80107227
...
80101ec8:	68 42 78 10 80       	push   $0x80107842
...
80101fdb:	68 b4 72 10 80       	push   $0x801072b4
80101fe0:	e8 ab e3 ff ff       	call   80100390 <panic>
    panic("idestart");
80101fe5:	83 ec 0c             	sub    $0xc,%esp
80101fe8:	68 ab 72 10 80       	push   $0x801072ab
...
80102006:	68 c6 72 10 80       	push   $0x801072c6
...
801020f1:	e8 ea 1f 00 00       	call   801040e0 <wakeup>
...
8010212e:	e8 3d 22 00 00       	call   80104370 <holdingsleep>
...
801021fa:	68 e0 72 10 80       	push   $0x801072e0
801021ff:	e8 8c e1 ff ff       	call   80100390 <panic>
    panic("iderw: buf not locked");
80102204:	83 ec 0c             	sub    $0xc,%esp
80102207:	68 ca 72 10 80       	push   $0x801072ca
8010220c:	e8 7f e1 ff ff       	call   80100390 <panic>
    panic("iderw: ide disk 1 not present");
80102211:	83 ec 0c             	sub    $0xc,%esp
80102214:	68 f5 72 10 80       	push   $0x801072f5
...
80102267:	68 14 73 10 80       	push   $0x80107314
...
80102395:	68 46 73 10 80       	push   $0x80107346
...
801023fb:	68 4c 73 10 80       	push   $0x8010734c
...
80102573:	0f b6 82 80 74 10 80 	movzbl -0x7fef8b80(%edx),%eax
8010257a:	09 c1                	or     %eax,%ecx
  shift ^= togglecode[data];
8010257c:	0f b6 82 80 73 10 80 	movzbl -0x7fef8c80(%edx),%eax
...
80102590:	83 e1 08             	and    $0x8,%ecx
  c = charcode[shift & (CTL | SHIFT)][data];
80102593:	8b 04 85 60 73 10 80 	mov    -0x7fef8ca0(,%eax,4),%eax
...
801025b5:	0f 44 d0             	cmove  %eax,%edx
    shift &= ~(shiftcode[data] | E0ESC);
801025b8:	0f b6 82 80 74 10 80 	movzbl -0x7fef8b80(%edx),%eax
...
80102b0a:	68 80 75 10 80       	push   $0x80107580
...
80102d12:	00 00 00 
    wakeup(&log);
80102d15:	e8 c6 13 00 00       	call   801040e0 <wakeup>
    release(&log.lock);
...
80102d40:	e8 9b 13 00 00       	call   801040e0 <wakeup>
  release(&log.lock);
...
80102d5f:	68 84 75 10 80       	push   $0x80107584
...
80102e29:	68 93 75 10 80       	push   $0x80107593
80102e2e:	e8 5d d5 ff ff       	call   80100390 <panic>
    panic("log_write outside of trans");
80102e33:	83 ec 0c             	sub    $0xc,%esp
80102e36:	68 a9 75 10 80       	push   $0x801075a9
...
80102e58:	68 c4 75 10 80       	push   $0x801075c4
80102e5d:	e8 fe d7 ff ff       	call   80100660 <cprintf>
  idtinit();       // load idt register
80102e62:	e8 89 2a 00 00       	call   801058f0 <idtinit>
...
80102e83:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102e86:	e8 65 3b 00 00       	call   801069f0 <switchkvm>
  seginit();
80102e8b:	e8 d0 3a 00 00       	call   80106960 <seginit>
  lapicinit();
...
80102ec1:	e8 fa 3f 00 00       	call   80106ec0 <kvmalloc>
  mpinit();        // detect other processors
80102ec6:	e8 75 01 00 00       	call   80103040 <mpinit>
  lapicinit();     // interrupt controller
80102ecb:	e8 60 f7 ff ff       	call   80102630 <lapicinit>
  seginit();       // segment descriptors
80102ed0:	e8 8b 3a 00 00       	call   80106960 <seginit>
  picinit();       // disable pic
...
80102ee4:	e8 47 2d 00 00       	call   80105c30 <uartinit>
  pinit();         // process table
80102ee9:	e8 52 08 00 00       	call   80103740 <pinit>
  tvinit();        // trap vectors
80102eee:	e8 7d 29 00 00       	call   80105870 <tvinit>
  binit();         // buffer cache
...
80102fee:	68 d8 75 10 80       	push   $0x801075d8
...
801030ac:	68 f5 75 10 80       	push   $0x801075f5
...
80103140:	ff 24 95 1c 76 10 80 	jmp    *-0x7fef89e4(,%edx,4)
...
801031f3:	68 dd 75 10 80       	push   $0x801075dd
801031f8:	e8 93 d1 ff ff       	call   80100390 <panic>
    panic("Didn't find a suitable machine");
801031fd:	83 ec 0c             	sub    $0xc,%esp
80103200:	68 fc 75 10 80       	push   $0x801075fc
...
801032f8:	00 00 00 
  initlock(&p->lock, "pipe");
801032fb:	68 30 76 10 80       	push   $0x80107630
...
80103653:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
80103659:	e8 62 0f 00 00       	call   801045c0 <release>
...
8010366b:	74 74                	je     801036e1 <allocproc+0xe1>
    return 0;
  }
...
8010367b:	89 53 18             	mov    %edx,0x18(%ebx)
  *(uint *)sp = (uint)trapret;
8010367e:	c7 40 14 62 58 10 80 	movl   $0x80105862,0x14(%eax)
  p->context = (struct context *)sp;
...
8010368d:	e8 7e 0f 00 00       	call   80104610 <memset>
...
80103695:	83 c4 10             	add    $0x10,%esp
  p->context->eip = (uint)forkret;
80103698:	c7 40 10 f0 36 10 80 	movl   $0x801036f0,0x10(%eax)
  p->ctime = ticks;
8010369f:	a1 a0 57 11 80       	mov    0x801157a0,%eax
  p->etime = 0;
...
801036b5:	00 00 00 
  p->ctime = ticks;
801036b8:	89 43 7c             	mov    %eax,0x7c(%ebx)
}
...
801036d2:	e8 e9 0e 00 00       	call   801045c0 <release>
}
...
801036fb:	e8 c0 0e 00 00       	call   801045c0 <release>
...
80103746:	68 35 76 10 80       	push   $0x80107635
8010374b:	68 20 2d 11 80       	push   $0x80112d20
80103750:	e8 6b 0c 00 00       	call   801043c0 <initlock>
}
...
801037c0:	68 3c 76 10 80       	push   $0x8010763c
801037c5:	e8 c6 cb ff ff       	call   80100390 <panic>
    panic("mycpu called with interrupts enabled\n");
801037ca:	83 ec 0c             	sub    $0xc,%esp
801037cd:	68 18 77 10 80       	push   $0x80107718
...
80103804:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103807:	e8 24 0c 00 00       	call   80104430 <pushcli>
  c = mycpu();
8010380c:	e8 4f ff ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103811:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103817:	e8 54 0c 00 00       	call   80104470 <popcli>
}
...
80103843:	e8 f8 35 00 00       	call   80106e40 <setupkvm>
...
80103861:	e8 ba 32 00 00       	call   80106b20 <inituvm>
...
801038d5:	e8 16 0f 00 00       	call   801047f0 <safestrcpy>
  p->cwd = namei("/");
...
80103925:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103928:	e8 03 0b 00 00       	call   80104430 <pushcli>
  c = mycpu();
8010392d:	e8 2e fe ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103932:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103938:	e8 33 0b 00 00       	call   80104470 <popcli>
  if (n > 0)
...
8010394c:	e8 bf 30 00 00       	call   80106a10 <switchuvm>
  return 0;
...
8010396a:	e8 f1 32 00 00       	call   80106c60 <allocuvm>
...
8010398a:	e8 01 34 00 00       	call   80106d90 <deallocuvm>
...
801039a6:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
801039a9:	e8 82 0a 00 00       	call   80104430 <pushcli>
  c = mycpu();
801039ae:	e8 ad fd ff ff       	call   80103760 <mycpu>
  p = c->proc;
801039b3:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
801039b9:	e8 b2 0a 00 00       	call   80104470 <popcli>
  if ((np = allocproc()) == 0)
...
801039d8:	e8 33 35 00 00       	call   80106f10 <copyuvm>
...
80103a51:	e8 9a 0d 00 00       	call   801047f0 <safestrcpy>
  pid = np->pid;
80103a56:	8b 5f 10             	mov    0x10(%edi),%ebx
  acquire(&ptable.lock);
80103a59:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
80103a60:	e8 9b 0a 00 00       	call   80104500 <acquire>
  np->state = RUNNABLE;
...
80103acb:	e8 30 0a 00 00       	call   80104500 <acquire>
80103ad0:	83 c4 10             	add    $0x10,%esp
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103ad3:	b8 54 2d 11 80       	mov    $0x80112d54,%eax
80103ad8:	90                   	nop
80103ad9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
     if(p->state==RUNNING)
80103ae0:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
80103ae4:	75 07                	jne    80103aed <update_run_time+0x2d>
      p->rtime++;
80103ae6:	83 80 84 00 00 00 01 	addl   $0x1,0x84(%eax)
   for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103aed:	05 88 00 00 00       	add    $0x88,%eax
80103af2:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
80103af7:	72 e7                	jb     80103ae0 <update_run_time+0x20>
   release(&ptable.lock);
80103af9:	83 ec 0c             	sub    $0xc,%esp
80103afc:	68 20 2d 11 80       	push   $0x80112d20
80103b01:	e8 ba 0a 00 00       	call   801045c0 <release>
}
...
80103b16:	83 ec 0c             	sub    $0xc,%esp
  struct cpu *c = mycpu();
80103b19:	e8 42 fc ff ff       	call   80103760 <mycpu>
...
80103b3e:	e8 bd 09 00 00       	call   80104500 <acquire>
...
80103b60:	e8 ab 2e 00 00       	call   80106a10 <switchuvm>
...
80103b6b:	c7 43 0c 04 00 00 00 	movl   $0x4,0xc(%ebx)
      swtch(&(c->scheduler), p->context);
80103b72:	e8 d4 0c 00 00       	call   8010484b <swtch>
      switchkvm();
80103b77:	e8 74 2e 00 00       	call   801069f0 <switchkvm>
      c->proc = 0;
80103b7c:	c7 86 ac 00 00 00 00 	movl   $0x0,0xac(%esi)
80103b83:	00 00 00 
80103b86:	83 c4 10             	add    $0x10,%esp
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103b89:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103b8f:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80103b95:	72 b9                	jb     80103b50 <scheduler+0x40>
    release(&ptable.lock);
80103b97:	83 ec 0c             	sub    $0xc,%esp
80103b9a:	68 20 2d 11 80       	push   $0x80112d20
80103b9f:	e8 1c 0a 00 00       	call   801045c0 <release>
    sti();
...
80103c13:	e8 33 0c 00 00       	call   8010484b <swtch>
  mycpu()->intena = intena;
...
80103c76:	83 ec 0c             	sub    $0xc,%esp
  pushcli();
80103c79:	e8 b2 07 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103c7e:	e8 dd fa ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103c83:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103c89:	e8 e2 07 00 00       	call   80104470 <popcli>
  if (curproc == initproc)
...
80103ce2:	e8 19 08 00 00       	call   80104500 <acquire>
...
80103d76:	eb e0                	jmp    80103d58 <exit+0xe8>
  curproc->etime = ticks;
80103d78:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
80103d92:	68 bd 76 10 80       	push   $0x801076bd
80103d97:	e8 f4 c5 ff ff       	call   80100390 <panic>
    panic("init exiting");
80103d9c:	83 ec 0c             	sub    $0xc,%esp
80103d9f:	68 b0 76 10 80       	push   $0x801076b0
...
80103dbc:	e8 3f 07 00 00       	call   80104500 <acquire>
  pushcli();
80103dc1:	e8 6a 06 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103dc6:	e8 95 f9 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103dcb:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103dd1:	e8 9a 06 00 00       	call   80104470 <popcli>
...
80103de9:	e8 d2 07 00 00       	call   801045c0 <release>
}
...
80103e0f:	e8 1c 06 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103e14:	e8 47 f9 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103e19:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103e1f:	e8 4c 06 00 00       	call   80104470 <popcli>
  if (p == 0)
...
80103e40:	e8 bb 06 00 00       	call   80104500 <acquire>
    release(lk);
80103e45:	89 34 24             	mov    %esi,(%esp)
80103e48:	e8 73 07 00 00       	call   801045c0 <release>
  p->chan = chan;
...
80103e6a:	e8 51 07 00 00       	call   801045c0 <release>
    acquire(lk);
...
80103e7b:	5d                   	pop    %ebp
    acquire(lk);
80103e7c:	e9 7f 06 00 00       	jmp    80104500 <acquire>
...
80103ea9:	68 cf 76 10 80       	push   $0x801076cf
80103eae:	e8 dd c4 ff ff       	call   80100390 <panic>
    panic("sleep");
80103eb3:	83 ec 0c             	sub    $0xc,%esp
80103eb6:	68 c9 76 10 80       	push   $0x801076c9
...
80103ec5:	e8 66 05 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103eca:	e8 91 f8 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103ecf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103ed5:	e8 96 05 00 00       	call   80104470 <popcli>
  acquire(&ptable.lock);
80103eda:	83 ec 0c             	sub    $0xc,%esp
80103edd:	68 20 2d 11 80       	push   $0x80112d20
80103ee2:	e8 19 06 00 00       	call   80104500 <acquire>
...
80103efe:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80103f0f:	74 37                	je     80103f48 <wait+0x88>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f11:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80103f17:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80103f1c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80103f5a:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80103f61:	e8 5a 2e 00 00       	call   80106dc0 <freevm>
        release(&ptable.lock);
...
80103f86:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103f8d:	e8 2e 06 00 00       	call   801045c0 <release>
        return pid;
...
80103fab:	e8 10 06 00 00       	call   801045c0 <release>
      return -1;
...
80103fc4:	53                   	push   %ebx
  pushcli();
80103fc5:	e8 66 04 00 00       	call   80104430 <pushcli>
  c = mycpu();
80103fca:	e8 91 f7 ff ff       	call   80103760 <mycpu>
  p = c->proc;
80103fcf:	8b b0 ac 00 00 00    	mov    0xac(%eax),%esi
  popcli();
80103fd5:	e8 96 04 00 00       	call   80104470 <popcli>
  acquire(&ptable.lock);
80103fda:	83 ec 0c             	sub    $0xc,%esp
80103fdd:	68 20 2d 11 80       	push   $0x80112d20
80103fe2:	e8 19 05 00 00       	call   80104500 <acquire>
...
80103ff8:	81 c3 88 00 00 00    	add    $0x88,%ebx
80103ffe:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104004:	73 1e                	jae    80104024 <waitx+0x64>
      if (p->parent != curproc)
80104006:	39 73 14             	cmp    %esi,0x14(%ebx)
80104009:	75 ed                	jne    80103ff8 <waitx+0x38>
      if (p->state == ZOMBIE)
8010400b:	83 7b 0c 05          	cmpl   $0x5,0xc(%ebx)
8010400f:	74 3f                	je     80104050 <waitx+0x90>
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
80104011:	81 c3 88 00 00 00    	add    $0x88,%ebx
      havekids = 1;
80104017:	b8 01 00 00 00       	mov    $0x1,%eax
    for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010401c:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
80104022:	72 e2                	jb     80104006 <waitx+0x46>
    if (!havekids || curproc->killed)
80104024:	85 c0                	test   %eax,%eax
80104026:	0f 84 99 00 00 00    	je     801040c5 <waitx+0x105>
8010402c:	8b 46 24             	mov    0x24(%esi),%eax
8010402f:	85 c0                	test   %eax,%eax
80104031:	0f 85 8e 00 00 00    	jne    801040c5 <waitx+0x105>
    sleep(curproc, &ptable.lock); //DOC: wait-sleep
80104037:	83 ec 08             	sub    $0x8,%esp
8010403a:	68 20 2d 11 80       	push   $0x80112d20
8010403f:	56                   	push   %esi
80104040:	e8 bb fd ff ff       	call   80103e00 <sleep>
    havekids = 0;
80104045:	83 c4 10             	add    $0x10,%esp
80104048:	eb a0                	jmp    80103fea <waitx+0x2a>
8010404a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        *wtime = p->etime - p->ctime - p->rtime;
80104050:	8b 83 80 00 00 00    	mov    0x80(%ebx),%eax
80104056:	2b 43 7c             	sub    0x7c(%ebx),%eax
        kfree(p->kstack);
80104059:	83 ec 0c             	sub    $0xc,%esp
        *wtime = p->etime - p->ctime - p->rtime;
8010405c:	2b 83 84 00 00 00    	sub    0x84(%ebx),%eax
80104062:	8b 55 08             	mov    0x8(%ebp),%edx
80104065:	89 02                	mov    %eax,(%edx)
        *rtime = p->rtime;
80104067:	8b 45 0c             	mov    0xc(%ebp),%eax
8010406a:	8b 93 84 00 00 00    	mov    0x84(%ebx),%edx
80104070:	89 10                	mov    %edx,(%eax)
        kfree(p->kstack);
80104072:	ff 73 08             	pushl  0x8(%ebx)
        pid = p->pid;
80104075:	8b 73 10             	mov    0x10(%ebx),%esi
        kfree(p->kstack);
80104078:	e8 93 e2 ff ff       	call   80102310 <kfree>
        freevm(p->pgdir);
8010407d:	5a                   	pop    %edx
8010407e:	ff 73 04             	pushl  0x4(%ebx)
        p->kstack = 0;
80104081:	c7 43 08 00 00 00 00 	movl   $0x0,0x8(%ebx)
        freevm(p->pgdir);
80104088:	e8 33 2d 00 00       	call   80106dc0 <freevm>
        release(&ptable.lock);
8010408d:	c7 04 24 20 2d 11 80 	movl   $0x80112d20,(%esp)
        p->pid = 0;
...
801040ad:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
801040b4:	e8 07 05 00 00       	call   801045c0 <release>
        return pid;
...
801040c8:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
801040cd:	68 20 2d 11 80       	push   $0x80112d20
801040d2:	e8 e9 04 00 00       	call   801045c0 <release>
      return -1;
801040d7:	83 c4 10             	add    $0x10,%esp
801040da:	eb e0                	jmp    801040bc <waitx+0xfc>
...
801040ef:	e8 0c 04 00 00       	call   80104500 <acquire>
...
80104105:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80104117:	c7 40 0c 03 00 00 00 	movl   $0x3,0xc(%eax)
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
8010411e:	05 88 00 00 00       	add    $0x88,%eax
80104123:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
80104134:	c9                   	leave  
  release(&ptable.lock);
80104135:	e9 86 04 00 00       	jmp    801045c0 <release>
...
80104165:	3d 54 4f 11 80       	cmp    $0x80114f54,%eax
...
8010418d:	e8 2e 04 00 00       	call   801045c0 <release>
      return 0;
...
801041a8:	e8 13 04 00 00       	call   801045c0 <release>
  return -1;
...
801041db:	68 5b 7a 10 80       	push   $0x80107a5b
801041e0:	e8 7b c4 ff ff       	call   80100660 <cprintf>
801041e5:	83 c4 10             	add    $0x10,%esp
  for (p = ptable.proc; p < &ptable.proc[NPROC]; p++)
801041e8:	81 c3 88 00 00 00    	add    $0x88,%ebx
801041ee:	81 fb 54 4f 11 80    	cmp    $0x80114f54,%ebx
...
80104201:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80104204:	ba e0 76 10 80       	mov    $0x801076e0,%edx
    if (p->state >= 0 && p->state < NELEM(states) && states[p->state])
80104209:	77 11                	ja     8010421c <procdump+0x5c>
8010420b:	8b 14 85 40 77 10 80 	mov    -0x7fef88c0(,%eax,4),%edx
      state = "???";
80104212:	b8 e0 76 10 80       	mov    $0x801076e0,%eax
...
80104224:	68 e4 76 10 80       	push   $0x801076e4
...
8010424b:	e8 90 01 00 00       	call   801043e0 <getcallerpcs>
...
80104269:	68 21 71 10 80       	push   $0x80107121
...
8010429a:	68 58 77 10 80       	push   $0x80107758
...
801042f5:	e8 06 fb ff ff       	call   80103e00 <sleep>
  while (lk->locked) {
...
80104393:	e8 68 f4 ff ff       	call   80103800 <myproc>
...
80104439:	fa                   	cli    
  ...
  cli();
  if(mycpu()->ncli == 0)
8010443a:	e8 21 f3 ff ff       	call   80103760 <mycpu>
...
8010444f:	e8 0c f3 ff ff       	call   80103760 <mycpu>
...
8010449c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  if(mycpu()->ncli == 0 && mycpu()->intena)
801044a0:	e8 bb f2 ff ff       	call   80103760 <mycpu>
...
801044b5:	68 63 77 10 80       	push   $0x80107763
801044ba:	e8 d1 be ff ff       	call   80100390 <panic>
    panic("popcli");
801044bf:	83 ec 0c             	sub    $0xc,%esp
801044c2:	68 7a 77 10 80       	push   $0x8010777a
...
801044e8:	e8 73 f2 ff ff       	call   80103760 <mycpu>
...
80104544:	e8 17 f2 ff ff       	call   80103760 <mycpu>
...
801045a7:	68 81 77 10 80       	push   $0x80107781
...
801045fc:	68 89 77 10 80       	push   $0x80107789
...
80104867:	8b 5d 08             	mov    0x8(%ebp),%ebx
  struct proc *curproc = myproc();
8010486a:	e8 91 ef ff ff       	call   80103800 <myproc>
...
801048a7:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
801048aa:	e8 51 ef ff ff       	call   80103800 <myproc>
...
80104915:	e8 e6 ee ff ff       	call   80103800 <myproc>
...
80104923:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104926:	e8 d5 ee ff ff       	call   80103800 <myproc>
  if(addr >= curproc->sz || addr+4 > curproc->sz)
...
80104968:	8b 5d 10             	mov    0x10(%ebp),%ebx
  int i;
  struct proc *curproc = myproc();
8010496b:	e8 90 ee ff ff       	call   80103800 <myproc>
...
80104a04:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104a07:	e8 f4 ed ff ff       	call   80103800 <myproc>
...
80104a17:	83 fa 15             	cmp    $0x15,%edx
...
80104a40:	68 91 77 10 80       	push   $0x80107791
...
80104b94:	68 38 78 10 80       	push   $0x80107838
...
80104bac:	68 37 78 10 80       	push   $0x80107837
...
80104bc5:	68 2b 78 10 80       	push   $0x8010782b
...
80104bda:	68 3a 78 10 80       	push   $0x8010783a
80104bdf:	e8 ac b7 ff ff       	call   80100390 <panic>
    panic("create: ialloc");
80104be4:	83 ec 0c             	sub    $0xc,%esp
80104be7:	68 1c 78 10 80       	push   $0x8010781c
...
80104c24:	e8 d7 eb ff ff       	call   80103800 <myproc>
...
80104c69:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
80104c6b:	e8 90 eb ff ff       	call   80103800 <myproc>
...
80104db3:	78 2b                	js     80104de0 <sys_close+0x40>
  myproc()->ofile[fd] = 0;
80104db5:	e8 46 ea ff ff       	call   80103800 <myproc>
...
80104fd9:	58                   	pop    %eax
80104fda:	5a                   	pop    %edx
80104fdb:	68 38 78 10 80       	push   $0x80107838
...
80104ff4:	68 37 78 10 80       	push   $0x80107837
...
801051ef:	0f 84 a6 00 00 00    	je     8010529b <sys_open+0x12b>
  struct proc *curproc = myproc();
801051f5:	e8 06 e6 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
801053c5:	83 ec 10             	sub    $0x10,%esp
  ...
  struct inode *ip;
  struct proc *curproc = myproc();
801053c8:	e8 33 e4 ff ff       	call   80103800 <myproc>
...
8010559f:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
801055a1:	e8 5a e2 ff ff       	call   80103800 <myproc>
...
801055c7:	8b 7d e4             	mov    -0x1c(%ebp),%edi
  struct proc *curproc = myproc();
801055ca:	e8 31 e2 ff ff       	call   80103800 <myproc>
  for(fd = 0; fd < NOFILE; fd++){
...
80105601:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
      myproc()->ofile[fd0] = 0;
80105608:	e8 f3 e1 ff ff       	call   80103800 <myproc>
...
80105643:	5d                   	pop    %ebp
  return fork();
80105644:	e9 57 e3 ff ff       	jmp    801039a0 <fork>
...
80105653:	83 ec 08             	sub    $0x8,%esp
  exit();
80105656:	e8 15 e6 ff ff       	call   80103c70 <exit>
...
80105663:	5d                   	pop    %ebp
  return wait();
80105664:	e9 57 e8 ff ff       	jmp    80103ec0 <wait>
...
8010567e:	e8 dd f2 ff ff       	call   80104960 <argptr>
80105683:	83 c4 10             	add    $0x10,%esp
80105686:	85 c0                	test   %eax,%eax
    return 12;
80105688:	ba 0c 00 00 00       	mov    $0xc,%edx
  if(argptr(0, (char**)&wtime, sizeof(int)) < 0)
8010568d:	78 2f                	js     801056be <sys_waitx+0x4e>

  if(argptr(1, (char**)&rtime, sizeof(int)) < 0)
8010568f:	8d 45 f4             	lea    -0xc(%ebp),%eax
80105692:	83 ec 04             	sub    $0x4,%esp
80105695:	6a 04                	push   $0x4
80105697:	50                   	push   %eax
80105698:	6a 01                	push   $0x1
8010569a:	e8 c1 f2 ff ff       	call   80104960 <argptr>
8010569f:	83 c4 10             	add    $0x10,%esp
801056a2:	85 c0                	test   %eax,%eax
    return 13;
801056a4:	ba 0d 00 00 00       	mov    $0xd,%edx
  if(argptr(1, (char**)&rtime, sizeof(int)) < 0)
801056a9:	78 13                	js     801056be <sys_waitx+0x4e>

  return waitx(wtime,rtime);
801056ab:	83 ec 08             	sub    $0x8,%esp
801056ae:	ff 75 f4             	pushl  -0xc(%ebp)
801056b1:	ff 75 f0             	pushl  -0x10(%ebp)
801056b4:	e8 07 e9 ff ff       	call   80103fc0 <waitx>
...
80105713:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105716:	e8 e5 e0 ff ff       	call   80103800 <myproc>
...
80105737:	78 27                	js     80105760 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105739:	e8 c2 e0 ff ff       	call   80103800 <myproc>
  if(growproc(n) < 0)
...
80105746:	e8 d5 e1 ff ff       	call   80103920 <growproc>
...
80105795:	e8 66 ed ff ff       	call   80104500 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
8010579a:	8b 55 f4             	mov    -0xc(%ebp),%edx
8010579d:	83 c4 10             	add    $0x10,%esp
  ticks0 = ticks;
801057a0:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  while(ticks - ticks0 < n){
...
801057b8:	68 a0 57 11 80       	push   $0x801157a0
801057bd:	e8 3e e6 ff ff       	call   80103e00 <sleep>
  while(ticks - ticks0 < n){
801057c2:	a1 a0 57 11 80       	mov    0x801157a0,%eax
...
801057e5:	e8 d6 ed ff ff       	call   801045c0 <release>
      return -1;
...
80105808:	e8 b3 ed ff ff       	call   801045c0 <release>
  return 0;
...
80105824:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105827:	68 60 4f 11 80       	push   $0x80114f60
8010582c:	e8 cf ec ff ff       	call   80104500 <acquire>
  xticks = ticks;
80105831:	8b 1d a0 57 11 80    	mov    0x801157a0,%ebx
  release(&tickslock);
80105837:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
8010583e:	e8 7d ed ff ff       	call   801045c0 <release>
  return xticks;
}
...
80105887:	c7 04 c5 a2 4f 11 80 	movl   $0x8e000008,-0x7feeb05e(,%eax,8)
8010588e:	08 00 00 8e 
80105892:	66 89 14 c5 a0 4f 11 	mov    %dx,-0x7feeb060(,%eax,8)
80105899:	80 
8010589a:	c1 ea 10             	shr    $0x10,%edx
8010589d:	66 89 14 c5 a6 4f 11 	mov    %dx,-0x7feeb05a(,%eax,8)
801058a4:	80 
  for (i = 0; i < 256; i++)
...
801058b4:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
801058b7:	c7 05 a2 51 11 80 08 	movl   $0xef000008,0x801151a2
801058be:	00 00 ef 
  initlock(&tickslock, "time");
801058c1:	68 7d 78 10 80       	push   $0x8010787d
801058c6:	68 60 4f 11 80       	push   $0x80114f60
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE << 3, vectors[T_SYSCALL], DPL_USER);
801058cb:	66 a3 a0 51 11 80    	mov    %ax,0x801151a0
801058d1:	c1 e8 10             	shr    $0x10,%eax
801058d4:	66 a3 a6 51 11 80    	mov    %ax,0x801151a6
  initlock(&tickslock, "time");
...
801058fb:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801058ff:	b8 a0 4f 11 80       	mov    $0x80114fa0,%eax
...
80105940:	ff 24 85 24 79 10 80 	jmp    *-0x7fef86dc(,%eax,4)
...
8010595a:	0f 84 19 02 00 00    	je     80105b79 <trap+0x259>
80105960:	f6 47 3c 03          	testb  $0x3,0x3c(%edi)
80105964:	0f 84 0f 02 00 00    	je     80105b79 <trap+0x259>
...
80105970:	e8 6b de ff ff       	call   801037e0 <cpuid>
...
801059a5:	68 e0 78 10 80       	push   $0x801078e0
...
801059be:	e8 3d de ff ff       	call   80103800 <myproc>
801059c3:	85 c0                	test   %eax,%eax
801059c5:	74 1d                	je     801059e4 <trap+0xc4>
801059c7:	e8 34 de ff ff       	call   80103800 <myproc>
...
801059e4:	e8 17 de ff ff       	call   80103800 <myproc>
801059e9:	85 c0                	test   %eax,%eax
801059eb:	74 0b                	je     801059f8 <trap+0xd8>
801059ed:	e8 0e de ff ff       	call   80103800 <myproc>
...
801059f6:	74 68                	je     80105a60 <trap+0x140>
  ...
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
801059f8:	e8 03 de ff ff       	call   80103800 <myproc>
...
80105a3d:	89 78 18             	mov    %edi,0x18(%eax)
    syscall();
80105a40:	e8 bb ef ff ff       	call   80104a00 <syscall>
    if (myproc()->killed)
80105a45:	e8 b6 dd ff ff       	call   80103800 <myproc>
...
80105a7d:	e8 ce cc ff ff       	call   80102750 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105a82:	e8 79 dd ff ff       	call   80103800 <myproc>
...
80105a94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    kbdintr();
80105a98:	e8 73 cb ff ff       	call   80102610 <kbdintr>
    lapiceoi();
...
80105ab4:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    uartintr();
80105ab8:	e8 63 02 00 00       	call   80105d20 <uartintr>
    lapiceoi();
80105abd:	e8 8e cc ff ff       	call   80102750 <lapiceoi>
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105ac2:	e8 39 dd ff ff       	call   80103800 <myproc>
...
80105adf:	e8 fc dc ff ff       	call   801037e0 <cpuid>
80105ae4:	56                   	push   %esi
80105ae5:	53                   	push   %ebx
80105ae6:	50                   	push   %eax
80105ae7:	68 88 78 10 80       	push   $0x80107888
80105aec:	e8 6f ab ff ff       	call   80100660 <cprintf>
    lapiceoi();
80105af1:	e8 5a cc ff ff       	call   80102750 <lapiceoi>
    break;
80105af6:	83 c4 10             	add    $0x10,%esp
  if (myproc() && myproc()->killed && (tf->cs & 3) == DPL_USER)
80105af9:	e8 02 dd ff ff       	call   80103800 <myproc>
...
80105b0c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ideintr();
80105b10:	e8 6b c5 ff ff       	call   80102080 <ideintr>
80105b15:	e9 63 ff ff ff       	jmp    80105a7d <trap+0x15d>
80105b1a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      exit();
80105b20:	e8 4b e1 ff ff       	call   80103c70 <exit>
80105b25:	e9 0e ff ff ff       	jmp    80105a38 <trap+0x118>
80105b2a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    exit();
80105b30:	e8 3b e1 ff ff       	call   80103c70 <exit>
80105b35:	e9 aa fe ff ff       	jmp    801059e4 <trap+0xc4>
80105b3a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
      acquire(&tickslock);
80105b40:	83 ec 0c             	sub    $0xc,%esp
80105b43:	68 60 4f 11 80       	push   $0x80114f60
80105b48:	e8 b3 e9 ff ff       	call   80104500 <acquire>
      wakeup(&ticks);
80105b4d:	c7 04 24 a0 57 11 80 	movl   $0x801157a0,(%esp)
      ticks++;
80105b54:	83 05 a0 57 11 80 01 	addl   $0x1,0x801157a0
      wakeup(&ticks);
80105b5b:	e8 80 e5 ff ff       	call   801040e0 <wakeup>
      release(&tickslock);
80105b60:	c7 04 24 60 4f 11 80 	movl   $0x80114f60,(%esp)
80105b67:	e8 54 ea ff ff       	call   801045c0 <release>
      update_run_time();
80105b6c:	e8 4f df ff ff       	call   80103ac0 <update_run_time>
80105b71:	83 c4 10             	add    $0x10,%esp
80105b74:	e9 04 ff ff ff       	jmp    80105a7d <trap+0x15d>
80105b79:	0f 20 d6             	mov    %cr2,%esi
      cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
80105b7c:	e8 5f dc ff ff       	call   801037e0 <cpuid>
80105b81:	83 ec 0c             	sub    $0xc,%esp
80105b84:	56                   	push   %esi
80105b85:	53                   	push   %ebx
80105b86:	50                   	push   %eax
80105b87:	ff 77 30             	pushl  0x30(%edi)
80105b8a:	68 ac 78 10 80       	push   $0x801078ac
80105b8f:	e8 cc aa ff ff       	call   80100660 <cprintf>
      panic("trap");
80105b94:	83 c4 14             	add    $0x14,%esp
80105b97:	68 82 78 10 80       	push   $0x80107882
80105b9c:	e8 ef a7 ff ff       	call   80100390 <panic>
80105ba1:	66 90                	xchg   %ax,%ax
80105ba3:	66 90                	xchg   %ax,%ax
80105ba5:	66 90                	xchg   %ax,%ax
80105ba7:	66 90                	xchg   %ax,%ax
80105ba9:	66 90                	xchg   %ax,%ax
80105bab:	66 90                	xchg   %ax,%ax
...
80105c05:	e8 66 cb ff ff       	call   80102770 <microdelay>
...
80105c9c:	83 ec 08             	sub    $0x8,%esp
  for(p="xv6...\n"; *p; p++)
80105c9f:	bb a4 79 10 80       	mov    $0x801079a4,%ebx
  ioapicenable(IRQ_COM1, 0);
80105ca4:	6a 00                	push   $0x0
80105ca6:	6a 04                	push   $0x4
80105ca8:	e8 23 c6 ff ff       	call   801022d0 <ioapicenable>
...
801067f4:	e8 c7 bc ff ff       	call   801024c0 <kalloc>
...
8010680a:	e8 01 de ff ff       	call   80104610 <memset>
    *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106904:	e8 07 ba ff ff       	call   80102310 <kfree>
      *pte = 0;
...
80106963:	83 ec 18             	sub    $0x18,%esp
  c = &cpus[cpuid()];
80106966:	e8 75 ce ff ff       	call   801037e0 <cpuid>
...
801069f0:	a1 a4 57 11 80       	mov    0x801157a4,%eax
{
...
80106a34:	0f 84 c2 00 00 00    	je     80106afc <switchuvm+0xec>
  pushcli();
80106a3a:	e8 f1 d9 ff ff       	call   80104430 <pushcli>
  mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
80106a3f:	e8 1c cd ff ff       	call   80103760 <mycpu>
80106a44:	89 c6                	mov    %eax,%esi
80106a46:	e8 15 cd ff ff       	call   80103760 <mycpu>
...
80106a58:	e8 03 cd ff ff       	call   80103760 <mycpu>
...
80106aa1:	e8 ba cc ff ff       	call   80103760 <mycpu>
...
80106ab9:	e8 a2 cc ff ff       	call   80103760 <mycpu>
80106abe:	81 c6 00 10 00 00    	add    $0x1000,%esi
80106ac4:	89 70 0c             	mov    %esi,0xc(%eax)
  mycpu()->ts.iomb = (ushort) 0xFFFF;
80106ac7:	e8 94 cc ff ff       	call   80103760 <mycpu>
...
80106b3b:	77 49                	ja     80106b86 <inituvm+0x66>
  mem = kalloc();
80106b3d:	e8 7e b9 ff ff       	call   801024c0 <kalloc>
  memset(mem, 0, PGSIZE);
...
80106b4f:	e8 bc da ff ff       	call   80104610 <memset>
...
80106b80:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106b81:	e9 3a db ff ff       	jmp    801046c0 <memmove>
    panic("inituvm: more than a page");
80106b86:	83 ec 0c             	sub    $0xc,%esp
80106b89:	68 f1 79 10 80       	push   $0x801079f1
...
80106c11:	e8 4a ad ff ff       	call   80101960 <readi>
...
80106cab:	e8 60 d9 ff ff       	call   80104610 <memset>
...
80106cd9:	0f 86 81 00 00 00    	jbe    80106d60 <allocuvm+0x100>
    mem = kalloc();
80106cdf:	e8 dc b7 ff ff       	call   801024c0 <kalloc>
    if(mem == 0){
...
80106ced:	68 29 7a 10 80       	push   $0x80107a29
...
80106d23:	68 41 7a 10 80       	push   $0x80107a41
...
80106d4b:	e8 c0 b5 ff ff       	call   80102310 <kfree>
      return 0;
...
80106e0e:	e8 fd b4 ff ff       	call   80102310 <kfree>
...
80106e23:	5d                   	pop    %ebp
  kfree((char*)pgdir);
80106e24:	e9 e7 b4 ff ff       	jmp    80102310 <kfree>
    panic("freevm: no pgdir");
80106e29:	83 ec 0c             	sub    $0xc,%esp
80106e2c:	68 5d 7a 10 80       	push   $0x80107a5d
...
80106e45:	e8 76 b6 ff ff       	call   801024c0 <kalloc>
...
80106e60:	e8 ab d7 ff ff       	call   80104610 <memset>
...
80106eff:	68 6e 7a 10 80       	push   $0x80107a6e
...
80106f50:	e8 6b d7 ff ff       	call   801046c0 <memmove>
...
80106fa5:	89 45 e4             	mov    %eax,-0x1c(%ebp)
    if((mem = kalloc()) == 0)
80106fa8:	e8 13 b5 ff ff       	call   801024c0 <kalloc>
...
8010707f:	e8 3c d6 ff ff       	call   801046c0 <memmove>
    len -= n;
    buf += n;
